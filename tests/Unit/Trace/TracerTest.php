...
final class TracerTest extends TestCase
{
    ...
    {
        // Tracer does not measure wall time and write it as an attribute.
        // Callers who want a queryable duration put it in attributes
        // themselves. Regression guard: if any future refactor re-introduces
        // auto-stamping inside Tracer, this fails.
        $tracer = new Tracer($this->sink);
